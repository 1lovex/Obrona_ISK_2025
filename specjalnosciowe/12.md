...
- X.121
  _ Adres -> użytkownik końcowy (np.: 523)
  _ Zmienna długość
  _ Adres terytorialny
  _ Wykorzystywane są liczby dziesiętne
  _ Dwie formy:
  _ P (1) + DNIC (4) + NTN (max 10)
  _ P (1) + DCC (3) + NN (max 11)
  _ P – wskaźnik międzynarodowy
  _ DNIC – identyfikator sieci publicznej (np.: 2601, 260 – Polska, 1 – nr sieci)
  _ NTN – numer użytkownika
  _ DCC – numer kraju
  _ NN – numer krajowy \* Do adresacji wykorzystywany jest Frame Relay (FR)
